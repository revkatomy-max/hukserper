...
local function CheckItem(player, item)
    ...
    if fishId then
        ...
        SendWebhook("🚨 SECRET FISH DETECTED!", "linktr.ee/bloxgank", 16768768, {
...
Players.PlayerRemoving:Connect(function(player)
    ...
    SendWebhook("👋 PLAYER LEFT SERVER", "linktr.ee/bloxgank", 16729344, {
...
local function Startup()
    ...
    SendWebhook("🚀 WEBHOOK STARTED", "linktr.ee/bloxgank", 65280, {
