...
local MemberList = {
     ...
     { username = "cjmin131", display = "azkara", id = "1406639996127154246" },
     { username = "zeylith162", display = "vexara", id = "1284490745515999282" },
     { username = "neyyi_dearman", display = "neyyi", id = "1443066200945852477" },
     { username = "g66ddes", display = "LYNRINN", id = "984826107738062868" },
     { username = "ciipaaaa_5", display = "ciipaww", id = "1240230878089707550" },
     { username = "Choalyn_2", display = "Alyn_ikaa", id = "1467390946357416060" },
     { username = "23Skuy2", display = "Blazehunter233", id = "" },
     { username = "moncerisebleu", display = "moncerisebleu", id = "786950836034994216" },
     { username = "seungkims", display = "KIM", id = "" },
     { username = "flucidious", display = "fluc", id = "279691238494699530" },
     { username = "Ciks_s", display = "BIPOLAR", id = "1427563464636895243" },
     { username = "kipli_goblox", display = "KIPLI", id = "384320074640654336" },
     { username = " 4uuu_R1183", display = "MissTukinem", id = "1413937687504752700" },
     { username = "zupzupzuppasup", display = "RISKAAA", id = "766292778501275678" },
     { username = "alleThetwin", display = "alletheTwin", id = "" },
     { username = "natadecxco", display = "nata", id = "638355599574171668" },
     { username = "minxing_kim", display = "sherrylsin20", id = "484295718765461515" },
}
